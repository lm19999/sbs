...
//添加启蒙数据
    @Insert("insert into initiation (initiation_type_id,initiation_title,initiation_name,initiation_url,initiation_describe,initiation_status,remark)" +
            " values(#{initiationType.initiationTypeId},#{initiationTitle},#{initiationName},#{initiationUrl},#{initiationDescribe},#{initiationStatus},#{remark})")
